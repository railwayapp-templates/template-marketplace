# Deploy FileZilla | Desktop App in the Cloud on Railway

Desktop FileZilla streamed to any device. Password-gated, persistent.

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/filezilla)
...
| Service | Source | Type |
|---------|--------|------|
| filezilla | [nomideusz/filezilla-railway](https://github.com/nomideusz/filezilla-railway) | Web service |
...
| `PASSWORD` | (secret) | Login password for the desktop session. Keep it strong - this gates who can use your cloud FileZilla. |
...
[View on Railway →](https://railway.com/deploy/filezilla)
