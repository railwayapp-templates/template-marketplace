# Deploy Zoom Meeting SDK Auth Sample on Railway
...
| Service | Source | Type |
|---------|--------|------|
| meetingsdk-auth-endpoint-sample | [EkaanshArora/meetingsdk-auth-endpoint-sample](https://github.com/EkaanshArora/meetingsdk-auth-endpoint-sample) | Web service |

## Environment variables

| Variable | Default |
| --------- | ------- |
| `ZOOM_MEETING_SDK_SECRET` | (secret) |
