# Deploy Ktor Blog App on Railway
...
| Service | Source | Type |
|---------|--------|------|
| web | [Shreemanarjun/Blog_Server_Ktor](https://github.com/Shreemanarjun/Blog_Server_Ktor) | Web service |

## Configuration

- **Start command:** `java -jar build/libs/ktor_auth_jwt-0.0.1.jar`
