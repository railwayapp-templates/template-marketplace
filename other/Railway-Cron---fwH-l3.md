# Deploy Railway Cron on Railway
...
| Service | Source | Type |
|---------|--------|------|
| Cron Service | `ghcr.io/brody192/railway-cron:latest` | Worker |

## Environment variables

| Variable | Description |
| --------- | ----------- |
| `SCHEDULE_1` | Your First Schedule! <a href="https://bookmarklets.up.railway.app/cron-config/" target="_blank">Install the helper bookmarklet</a> |
