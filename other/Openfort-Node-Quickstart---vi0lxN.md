# Deploy Openfort Node Quickstart on Railway

Node backend quickstart using Openfort to interact with smart wallets.

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/template/vi0lxN)
...
| Service | Source | Type |
|---------|--------|------|
| node-backend | `https://github.com/openfort-xyz/samples` | Web service |

## Environment variables

| Variable | Default | Description |
| --------- | ------- | ----------- |
| `OPENFORT_SECRET_KEY` | (secret) | Openfort secret key, https://dashboard.openfort.xyz/apikeys |
...
[View on Railway →](https://railway.com/template/vi0lxN)
