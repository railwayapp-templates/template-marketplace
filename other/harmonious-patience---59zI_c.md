# Deploy harmonious-patience on Railway
...
| Service | Source | Type |
|---------|--------|------|
| wadoyuse server | [HaoChiBao/EmbedGPT](https://github.com/HaoChiBao/EmbedGPT) (root: /server) | Web service |

## Environment variables

| Variable | Default | Description |
| --------- | ------- | ----------- |
| `OPENAI_API_KEY` | (secret) | openai stuff |
