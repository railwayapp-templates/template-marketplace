# Deploy Firefox | Your Browser in the Cloud on Railway

Desktop Firefox streamed to any device. Password-gated, profile persists.

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/firefox-browser)
...
| Service | Source | Type |
|---------|--------|------|
| firefox | [nomideusz/firefox-railway](https://github.com/nomideusz/firefox-railway) | Web service |
...
| `FIREFOX_CLI` | - | URL(s) or flags to open at launch, e.g. https://example.com |
...
[View on Railway →](https://railway.com/deploy/firefox-browser)
