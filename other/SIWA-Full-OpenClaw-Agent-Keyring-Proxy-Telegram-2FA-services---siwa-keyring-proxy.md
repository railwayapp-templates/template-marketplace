# Deploy SIWA Full (OpenClaw Agent, Keyring Proxy, Telegram 2FA services) on Railway
...
| Service | Source | Type |
|---------|--------|------|
| OpenClaw_Agent | [arjunkomath/openclaw-railway-template](https://github.com/arjunkomath/openclaw-railway-template) | Web service |
...
| Keyring_Proxy | [builders-garden/siwa](https://github.com/builders-garden/siwa) (root: /packages/keyring-proxy) | Database |

## Environment variables

| Variable | Service | Default | Description |
| --------- | ------- | ------- | ----------- |
| `SETUP_PASSWORD` | OpenClaw_Agent | (secret) | Password to access the setup UI. Automatically generated. |
| `KEYRING_PROXY_URL` | OpenClaw_Agent | http://keyringproxy.railway.internal:3100 | API secret to communicate with the Keyring Service. |
| `OPENCLAW_STATE_DIR` | OpenClaw_Agent | /data/.openclaw | Where your OpenClaw data lives - configs, auth, sessions. |
| `KEYRING_PROXY_SECRET` | OpenClaw_Agent | (secret) | API secret to communicate with the Keyring Service. |
| `OPENCLAW_GATEWAY_TOKEN` | OpenClaw_Agent | (secret) | Token that protects your gateway. |
| `OPENCLAW_WORKSPACE_DIR` | OpenClaw_Agent | /data/workspace | Where all the files you create via OpenClaw will reside. |
