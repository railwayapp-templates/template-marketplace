# Deploy ReScript Frontend on Railway
...
| Service | Source | Type |
|---------|--------|------|
| Rescript React Frontend | [gretarst/railway-rescript-template](https://github.com/gretarst/railway-rescript-template) | Web service |
