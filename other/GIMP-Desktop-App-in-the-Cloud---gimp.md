# Deploy GIMP | Desktop App in the Cloud on Railway

Desktop GIMP streamed to any device. Password-gated, persistent.

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/gimp)
...
| Service | Source | Type |
|---------|--------|------|
| gimp | [nomideusz/gimp-railway](https://github.com/nomideusz/gimp-railway) | Web service |
...
| `PASSWORD` | (secret) | Login password for the desktop session. Keep it strong - this gates who can use your cloud GIMP. |
...
[View on Railway →](https://railway.com/deploy/gimp)
