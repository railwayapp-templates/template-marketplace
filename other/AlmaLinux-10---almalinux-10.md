...
| Service | Source | Type |
|---------|--------|------|
| alma-linux | `almalinux:10` | Database |
...
[View on Railway →](https://railway.com/deploy/almalinux-10)
