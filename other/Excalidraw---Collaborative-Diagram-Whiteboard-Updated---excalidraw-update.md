...
[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/excalidraw-update)
...
| `VITE_APP_PLUS_LP` | excalidraw | https://plus.excalidraw.com |
| `VITE_APP_PLUS_APP` | excalidraw | https://app.excalidraw.com |
| `VITE_APP_AI_BACKEND` | excalidraw | https://oss-ai.excalidraw.com |
| `VITE_APP_LIBRARY_URL` | excalidraw | https://libraries.excalidraw.com |
| `VITE_APP_LIBRARY_BACKEND` | excalidraw | https://us-central1-excalidraw-room-persistence.cloudfunctions.net/libraries |
| `VITE_APP_BACKEND_V2_GET_URL` | excalidraw | https://json.excalidraw.com/api/v2/ |
| `VITE_APP_BACKEND_V2_POST_URL` | excalidraw | https://json.excalidraw.com/api/v2/post/ |
...
[View on Railway →](https://railway.com/deploy/excalidraw-update)
