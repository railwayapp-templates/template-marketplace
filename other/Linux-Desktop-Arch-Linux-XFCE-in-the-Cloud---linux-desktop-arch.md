# Deploy Linux Desktop | Arch Linux XFCE in the Cloud on Railway

Arch Linux XFCE desktop in your browser. Password-gated, persistent.

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/linux-desktop-arch)
...
| Service | Source | Type |
|---------|--------|------|
| linux-desktop-arch | [nomideusz/webtop-arch-railway](https://github.com/nomideusz/webtop-arch-railway) | Web service |
...
| `TITLE` | Linux Desktop (Arch Linux XFCE) | Browser tab title for the desktop. |
...
[View on Railway →](https://railway.com/deploy/linux-desktop-arch)
