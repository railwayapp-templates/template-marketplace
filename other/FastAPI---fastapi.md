...
Deploy FastAPI on Railway with Uvicorn and health check endpoint.

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/fastapi)
...
[View on Railway →](https://railway.com/deploy/fastapi)
