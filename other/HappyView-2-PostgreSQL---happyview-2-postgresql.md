...
| HappyView | `ghcr.io/gamesgamesgamesgamesgames/happyview:2.11.2` | Web service |
...
| `SESSION_SECRET` | HappyView | (secret) | A random 48+ character string (e.g. `openssl rand -base64 48`) |
