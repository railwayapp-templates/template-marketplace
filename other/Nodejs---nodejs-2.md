...
Minimal Node.js 20 HTTP service on Railway with health endpoint.

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/nodejs-2)
...
[View on Railway →](https://railway.com/deploy/nodejs-2)
