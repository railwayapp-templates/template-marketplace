...
[Jul'26] Hosted Ubuntu workspace with SSH access & persistent storage.
...
| Service | Source | Type |
|---------|--------|------|
| ubuntu | `ubuntu:26.04` | Database |

## Configuration

- **Start command:** `bash -lc 'echo "Ubuntu 26.04 Railway container is running"; tail -f /dev/null'`
- **Volume:** `/data`

**Category:** Other

[View on Railway →](https://railway.com/deploy/ubuntu-2604-lts)
