...
| Service | Source | Type |
|---------|--------|------|
| quote-api | [fdvky1/quote-api](https://github.com/fdvky1/quote-api) | Web service |

## Environment variables

| Variable | Default | Description |
| --------- | ------- | ----------- |
| `BOT_TOKEN` | (secret) | your telegram bot token, can be created using https://t.me/BotFather |
