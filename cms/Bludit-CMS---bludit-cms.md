# Deploy Bludit CMS on Railway

Flat-file website CMS with persistent content, themes and plugins.

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/bludit-cms)
...
| bludit | [orenaksakal/railway-templates](https://github.com/orenaksakal/railway-templates) (branch: codex/unique-template-drafts) | Web service |
...
| `UPSTREAM_PORT` | 80 | Upstream port for bludit. The supplied value follows the pinned upstream deployment; change only with its configuration guide. |
...
[View on Railway →](https://railway.com/deploy/bludit-cms)
