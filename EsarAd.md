# Deploy respectful-eagerness on Railway
...
| Service | Source | Type |
|---------|--------|------|
| Backend_Project | [MohamedAbeid/Backend_Project](https://github.com/MohamedAbeid/Backend_Project) | Worker |
...
| --------- | ------- |
| `PORT` | 8000 |
| `DB_URI` | mongodb+srv://mohamedAbeid:Asdfg@smartshop.ffwq3.mongodb.net/Project |
| `BASE_URL` | http://localhost:8000 |
| `NODE_ENV` | development |
| `EMAIL_FROM` | Alsafa Sports < |
