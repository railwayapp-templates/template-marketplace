# Deploy Heavyweight - FastAPI on Railway
...
| Heavyweight FastAPI | [GrandGaleTechnologies/heavyweight-fastapi](https://github.com/GrandGaleTechnologies/heavyweight-fastapi) | Web service |
...
| `DEBUG` | Heavyweight FastAPI | false | - |
| `SECRET_KEY` | Heavyweight FastAPI | (secret) | This will be used to hash passwords and make sure to change it |
