# Deploy Langfuse v4.36.1 (Production ready AI Observability) on Railway
...
| langfuse-worker | `langfuse/langfuse-worker:4.36.1` | Worker |
...
| langfuse-web | `langfuse/langfuse:4.36.1` | Web service |
