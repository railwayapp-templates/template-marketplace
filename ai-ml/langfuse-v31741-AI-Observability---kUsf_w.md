# Deploy langfuse v3.174.1 (AI Observability) on Railway
...
| langfuse-web | `langfuse/langfuse:3.174.1` | Web service |
| minio | `minio/minio` | Database |
| langfuse-worker | `langfuse/langfuse-worker:3.174.1` | Worker |
