# Deploy langfuse v3.184.1 (AI Observability) on Railway
...
| langfuse-web | `langfuse/langfuse:3.184.1` | Web service |
| minio | `minio/minio` | Database |
| langfuse-worker | `langfuse/langfuse-worker:3.184.1` | Worker |
