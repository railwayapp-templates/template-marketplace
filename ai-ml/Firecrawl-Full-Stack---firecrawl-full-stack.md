# Deploy Firecrawl Full Stack on Railway

Firecrawl web scraping API with Playwright, Redis, RabbitMQ, and Postgres

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/firecrawl-full-stack)
...
[View on Railway →](https://railway.com/deploy/firecrawl-full-stack)
