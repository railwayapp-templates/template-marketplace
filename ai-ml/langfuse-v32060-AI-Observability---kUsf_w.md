# Deploy langfuse v3.206.0 (AI Observability) on Railway
...
| langfuse-web | `langfuse/langfuse:3.206.0` | Web service |
| minio | `minio/minio` | Database |
| langfuse-worker | `langfuse/langfuse-worker:3.206.0` | Worker |
