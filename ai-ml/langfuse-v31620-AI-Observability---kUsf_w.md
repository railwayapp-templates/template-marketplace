# Deploy langfuse v3.162.0 (AI Observability) on Railway
...
| langfuse-web | `langfuse/langfuse:3.162.0` | Web service |
| minio | `minio/minio` | Database |
| langfuse-worker | `langfuse/langfuse-worker:3.162.0` | Worker |
