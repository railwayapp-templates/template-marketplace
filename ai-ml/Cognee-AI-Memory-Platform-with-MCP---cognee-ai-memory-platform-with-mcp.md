...
[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/cognee-ai-memory-platform-with-mcp)
...
| cognee-mcp | `cognee/cognee-mcp:main` | Web service |
...
[View on Railway →](https://railway.com/deploy/cognee-ai-memory-platform-with-mcp)
