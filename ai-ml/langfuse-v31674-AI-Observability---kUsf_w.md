# Deploy langfuse v3.167.4 (AI Observability) on Railway
...
| langfuse-web | `langfuse/langfuse:3.167.4` | Web service |
| minio | `minio/minio` | Database |
| langfuse-worker | `langfuse/langfuse-worker:3.167.4` | Worker |
