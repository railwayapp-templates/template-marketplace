...
| `WEBSITE_HOSTNAME` | - | Public URL of this deployment. Auto-resolves to https://<railway-domain> so OAuth callbacks and CORS work out of the box. Override for custom domains (e.g., https://chat.example.com). |
