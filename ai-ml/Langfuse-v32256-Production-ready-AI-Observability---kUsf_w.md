# Deploy Langfuse v3.225.6 (Production ready AI Observability) on Railway
...
| langfuse-web | `langfuse/langfuse:3.225.6` | Web service |
| minio | `minio/minio` | Database |
| langfuse-worker | `langfuse/langfuse-worker:3.225.6` | Worker |
