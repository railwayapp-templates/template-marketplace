# Deploy Dify v1.15.0 on Railway
...
| Worker | `langgenius/dify-api:1.15.0` | Worker |
| Api | `langgenius/dify-api:1.15.0` | Web service |
...
| Web | `langgenius/dify-web:1.15.0` | Web service |
