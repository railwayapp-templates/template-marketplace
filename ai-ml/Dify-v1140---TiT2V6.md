# Deploy Dify v1.14.0 on Railway
...
| Worker | `langgenius/dify-api:1.14.0` | Worker |
| Api | `langgenius/dify-api:1.14.0` | Web service |
...
| Web | `langgenius/dify-web:1.14.0` | Web service |
