# Deploy Devin Discord Bot on Railway

Deploy and Host Devin Discord Bot with Railway

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/devin-discord-bot)
...
| Devin Discord Bot | `wgtechlabs/devin-discord-bot:latest` | Worker |
...
| `LOG_LEVEL` | Devin Discord Bot | info | - |
| `DEVIN_ORG_ID` | Devin Discord Bot | - | org_your_devin_org_id_here |
| `DEVIN_API_KEY` | Devin Discord Bot | (secret) | apk_your_devin_api_key_here |
| `DISCORD_BOT_TOKEN` | Devin Discord Bot | (secret) | your_discord_bot_token_here |
| `DISCORD_CLIENT_ID` | Devin Discord Bot | - | your_discord_client_id_here |
...
[View on Railway →](https://railway.com/deploy/devin-discord-bot)
