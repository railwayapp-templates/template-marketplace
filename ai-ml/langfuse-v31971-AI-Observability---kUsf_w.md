# Deploy langfuse v3.197.1 (AI Observability) on Railway
...
| langfuse-web | `langfuse/langfuse:3.197.1` | Web service |
| minio | `minio/minio` | Database |
| langfuse-worker | `langfuse/langfuse-worker:3.197.1` | Worker |
