# Deploy Dify v1.14.2 on Railway
...
| Worker | `langgenius/dify-api:1.14.2` | Worker |
| Api | `langgenius/dify-api:1.14.2` | Web service |
| Storage | `minio/minio:RELEASE.2025-02-28T09-55-16Z` | Database |
| plugin-daemon | `langgenius/dify-plugin-daemon:0.6.1-local` | Database |
| Postgres | `postgres:15-alpine` | Database |
| Redis | `redis:6-alpine` | Database |
| Web | `langgenius/dify-web:1.14.2` | Web service |
