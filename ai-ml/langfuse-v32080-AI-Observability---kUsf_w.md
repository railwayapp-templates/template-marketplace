# Deploy langfuse v3.208.0 (AI Observability) on Railway
...
| langfuse-web | `langfuse/langfuse:3.208.0` | Web service |
| minio | `minio/minio` | Database |
| langfuse-worker | `langfuse/langfuse-worker:3.208.0` | Worker |
