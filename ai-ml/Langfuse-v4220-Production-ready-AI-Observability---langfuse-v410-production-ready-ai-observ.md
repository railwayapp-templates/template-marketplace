# Deploy Langfuse v4.22.0 (Production ready AI Observability) on Railway
...
| langfuse-worker | `langfuse/langfuse-worker:4.22.0` | Worker |
...
| langfuse-web | `langfuse/langfuse:4.22.0` | Web service |
