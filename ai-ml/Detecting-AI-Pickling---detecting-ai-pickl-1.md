# Deploy Detecting AI Pickling on Railway
...
| Service | Source | Type |
|---------|--------|------|
| bryan_nice/sans/detecting_ai_pickling:v0.4.0 | `registry.gitlab.com/bryan_nice/sans/detecting_ai_pickling:v0.4.0` | Web service |
