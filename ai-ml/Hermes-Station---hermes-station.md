# Deploy Hermes Station on Railway

Hermes Agent with Hermes Web UI

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/hermes-station)
...
| Service | Source | Type |
|---------|--------|------|
| hermes-station | `ghcr.io/roryford/hermes-station:latest` | Web service |
...
| `HERMES_ADMIN_PASSWORD` | (secret) | Admin panel for advanced settings |
| `HERMES_WEBUI_PASSWORD` | (secret) | Main screen login |
...
[View on Railway →](https://railway.com/deploy/hermes-station)
