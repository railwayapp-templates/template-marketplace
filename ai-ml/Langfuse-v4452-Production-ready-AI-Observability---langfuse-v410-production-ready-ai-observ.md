# Deploy Langfuse v4.45.2 (Production ready AI Observability) on Railway
...
| langfuse-worker | `langfuse/langfuse-worker:4.45.2` | Worker |
...
| langfuse-web | `langfuse/langfuse:4.45.2` | Web service |
