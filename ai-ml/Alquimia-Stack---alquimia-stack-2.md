...
| studio | `alquimiaai/studio:latest-20260907-1748` | Web service |
| runtime | `alquimiaai/runtime:0.4.3` | Web service |
...
| `PROMETHEUS_STORAGE_PATH` | prometheus | /prometheus | - |
| `PORT` | vault | 8200 | Internal Vault HTTP API port. |
| `VAULT_DEV_ROOT_TOKEN_ID` | vault | (secret) | Generated Vault root token. |
| `VAULT_TOKEN` | trustlens | (secret) | - |
| `VAULT_MOUNT_POINT` | trustlens | secret | - |
| `TRUSTLENS_API_TOKEN` | trustlens | (secret) | - |
| `TRUSTLENS_ENVIRONMENT` | trustlens | staging | - |
| `TRUSTLENS_PROVIDER_ID` | trustlens | trustlens-gaussia | - |
| `TRUSTLENS_RUNTIME_API_TOKEN` | trustlens | (secret) | - |
| `TRUSTLENS_WORKER_CONCURRENCY` | trustlens | 2 | - |
...
| `TRUSTLENS_API_TOKEN` | studio | (secret) | - |
...
| `PORT` | trustlens-postgres | 5432 | - |
| `POSTGRES_DB` | trustlens-postgres | trustlens | - |
| `DATABASE_URL` | trustlens-postgres | - | URL to connect to Postgres database. |
| `POSTGRES_USER` | trustlens-postgres | (secret) | User to connect to Postgres DB |
| `POSTGRES_PASSWORD` | trustlens-postgres | (secret) | - |
| `DATABASE_PUBLIC_URL` | trustlens-postgres | - | Public URL to connect to Postgres database, used by the Data panel. |
