# Deploy Open Notebook + SurrealDB on Railway

Self-hosted NotebookLM alternative with SurrealDB, notes, chat and podcasts

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/open-notebook-surrealdb)
...
[View on Railway →](https://railway.com/deploy/open-notebook-surrealdb)
