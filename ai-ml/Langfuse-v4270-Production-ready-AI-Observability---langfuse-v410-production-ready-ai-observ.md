# Deploy Langfuse v4.27.0 (Production ready AI Observability) on Railway
...
| langfuse-worker | `langfuse/langfuse-worker:4.27.0` | Worker |
...
| langfuse-web | `langfuse/langfuse:4.27.0` | Web service |
