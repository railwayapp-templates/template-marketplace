# Deploy langfuse v3.203.3 (AI Observability) on Railway
...
| langfuse-web | `langfuse/langfuse:3.203.3` | Web service |
| minio | `minio/minio` | Database |
| langfuse-worker | `langfuse/langfuse-worker:3.203.3` | Worker |
