# Deploy langfuse v3.192.2 (AI Observability) on Railway
...
| langfuse-web | `langfuse/langfuse:3.192.2` | Web service |
| minio | `minio/minio` | Database |
| langfuse-worker | `langfuse/langfuse-worker:3.192.2` | Worker |
