...
| `OPENAI_API_KEY` | (secret) | Supermemory defaults to OpenAI, but you can use Anthropic, Gemini, or Groq by entering a placeholder for the OpenAI key and setting your preferred provider's key instead. |
