# Deploy langfuse v3.173.0 (AI Observability) on Railway
...
| langfuse-web | `langfuse/langfuse:3.173.0` | Web service |
| minio | `minio/minio` | Database |
| langfuse-worker | `langfuse/langfuse-worker:3.173.0` | Worker |
