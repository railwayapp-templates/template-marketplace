# Deploy Langfuse v4.46.0 (Production ready AI Observability) on Railway
...
| langfuse-worker | `langfuse/langfuse-worker:4.46.0` | Worker |
...
| langfuse-web | `langfuse/langfuse:4.46.0` | Web service |
