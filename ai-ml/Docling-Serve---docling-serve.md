...
Docling Serve exposes Docling's document understanding and conversion pipelines through synchronous and asynchronous REST APIs and an optional web UI. This template deploys stable CPU-only version 1.32.0 with generated API-key protection and bounded production defaults.
