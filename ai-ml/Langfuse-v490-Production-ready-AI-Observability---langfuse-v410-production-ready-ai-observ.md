# Deploy Langfuse v4.9.0 (Production ready AI Observability) on Railway
...
| langfuse-worker | `langfuse/langfuse-worker:4.9.0` | Worker |
...
| langfuse-web | `langfuse/langfuse:4.9.0` | Web service |
