# Deploy hermes agent: easy multi-model option for codex, open claw, claude code, codex and more on Railway

The simplest curated setup for an Hermes Agent. Curated by impacte.tech

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/hermes-agent-easy-multi-model-option-for)
...
[View on Railway →](https://railway.com/deploy/hermes-agent-easy-multi-model-option-for)
