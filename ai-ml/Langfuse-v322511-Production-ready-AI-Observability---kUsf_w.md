# Deploy Langfuse v3.225.11 (Production ready AI Observability) on Railway
...
| langfuse-web | `langfuse/langfuse:3.225.11` | Web service |
| minio | `minio/minio` | Database |
| langfuse-worker | `langfuse/langfuse-worker:3.225.11` | Worker |
