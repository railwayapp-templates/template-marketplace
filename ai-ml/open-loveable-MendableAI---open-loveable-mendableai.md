...
Chat with AI to build React apps instantly. An example app made by the Firecrawl team. For a complete cloud solution, check out Lovable.dev
...
| --------- | ------- | ----------- |
| `E2B_API_KEY` | (secret) | REQUIRED - Sandboxes for code execution. Get yours at https://e2b.dev |
