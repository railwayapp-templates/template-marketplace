# Deploy KittenTTS (Open-Source Text-to-Speech & Voice AI Tool) on Railway

Kitten TTS [Jun ’26] (Generate Natural AI Voices Instantly) Self Host
...
| Service | Source | Type |
|---------|--------|------|
| Kitten-TTS-Server-Railway | [Shinyduo/Kitten-TTS-Server-Railway](https://github.com/Shinyduo/Kitten-TTS-Server-Railway) | Web service |
