# Deploy langfuse v3.221.1 (AI Observability) on Railway
...
| langfuse-web | `langfuse/langfuse:3.221.1` | Web service |
| minio | `minio/minio` | Database |
| langfuse-worker | `langfuse/langfuse-worker:3.221.1` | Worker |
