# Deploy Langfuse v4.28.1 (Production ready AI Observability) on Railway
...
| langfuse-worker | `langfuse/langfuse-worker:4.28.1` | Worker |
...
| langfuse-web | `langfuse/langfuse:4.28.1` | Web service |
