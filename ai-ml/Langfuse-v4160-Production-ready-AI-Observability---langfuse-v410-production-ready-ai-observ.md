# Deploy Langfuse v4.16.0 (Production ready AI Observability) on Railway
...
| langfuse-worker | `langfuse/langfuse-worker:4.16.0` | Worker |
...
| langfuse-web | `langfuse/langfuse:4.16.0` | Web service |
