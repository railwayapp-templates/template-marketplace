# Deploy langfuse v3.202.1 (AI Observability) on Railway
...
| langfuse-web | `langfuse/langfuse:3.202.1` | Web service |
| minio | `minio/minio` | Database |
| langfuse-worker | `langfuse/langfuse-worker:3.202.1` | Worker |
