# Deploy Slack Bot Template in Python on Railway
...
| Service | Source | Type |
|---------|--------|------|
| slack-bot-template | [Alhwyn/slack-bot-template](https://github.com/Alhwyn/slack-bot-template) | Worker |

## Environment variables

| Variable | Default | Description |
| --------- | ------- | ----------- |
| `SLACK_BOT_TOKEN` | (secret) | OAuth & Permission after adding scopes and installing app |
| `SLACK_BOT_USER_ID` | - | found in Basic information |
| `SLACK_SIGNING_SECRET` | (secret) | found in basic information |
