# Deploy Neo4j GraphDB (Clone) on Railway

Deploy a fully managed Neo4j instance on Railway with ease.

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/neo4j-graphdb-clone)
...
| Service | Source | Type |
|---------|--------|------|
| neo4j | [sukrutnrvd/neo4j-template](https://github.com/sukrutnrvd/neo4j-template) (branch: feat) | TCP service |
...
[View on Railway →](https://railway.com/deploy/neo4j-graphdb-clone)
