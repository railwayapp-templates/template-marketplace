# Deploy n8n Alerts on Railway

uptime, errors & on-call alerts

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/n8n-alerts)
...
If you only need a single editor with no workers, use the [cheapest n8n without queue mode](https://railway.com/deploy/n8n) listing instead — this template is the queue-mode stack for error workflows and on-call alerts.
...
[View on Railway →](https://railway.com/deploy/n8n-alerts)
