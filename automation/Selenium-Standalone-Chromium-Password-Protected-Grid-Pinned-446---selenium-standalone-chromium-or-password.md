# Deploy Selenium Standalone Chromium | Password-Protected Grid, Pinned 4.46 on Railway

Password-protected Selenium 4.46 grid, Chromium 150, pinned image

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/selenium-standalone-chromium-or-password)

## About

Selenium is the W3C WebDriver stack that drives a real browser from your code. This template deploys **Selenium Standalone Chromium 4.46** — router, distributor and browser node in one container — behind an HTTPS URL your tests, scrapers and agents can point at, **with the router password-protected**.
...
[View on Railway →](https://railway.com/deploy/selenium-standalone-chromium-or-password)
