# Deploy n8n Self Host vs Cloud on Railway

Self-host n8n instead of n8n Cloud

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/n8n-self-host-vs-cloud)
...
[View on Railway →](https://railway.com/deploy/n8n-self-host-vs-cloud)
