# Deploy Selenium Standalone Firefox | Password-Protected Grid, Pinned 4.46 on Railway
...
| Service | Source | Type |
|---------|--------|------|
| selenium | `ghcr.io/bon5co/selenium-standalone-firefox-railway:latest` | Web service |
...
[View on Railway →](https://railway.com/deploy/selenium-standalone-firefox-or-password-)
