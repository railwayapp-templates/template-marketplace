# Deploy Hermes Agent (w/ Dashboard) on Railway

Hermes AI agent for Telegram, Discord and Slack with a locked web dashboard
...
[View on Railway →](https://railway.com/deploy/hermes-agent-w-dashboard)
