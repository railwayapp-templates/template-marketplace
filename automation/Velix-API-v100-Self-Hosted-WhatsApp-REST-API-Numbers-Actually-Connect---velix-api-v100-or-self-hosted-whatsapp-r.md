# Deploy Velix API v1.0.0 | Self-Hosted WhatsApp REST API, Numbers Actually Connect on Railway

Multi-number WhatsApp REST API. Numbers pair, signup closed, sessions kept
