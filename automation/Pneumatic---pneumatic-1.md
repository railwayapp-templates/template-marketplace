# Deploy Pneumatic on Railway

Open-source workflow management platform by Pneumatic

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/pneumatic-1)
...
| Frontend | [pneumaticapp/pneumaticworkflow](https://github.com/pneumaticapp/pneumaticworkflow) (root: /frontend) | Worker |
| Postgres | `postgres:15-bookworm` | Database |
| SeaweedFS Filer | `chrislusf/seaweedfs:3.95` | Database |
| nginx | [pneumaticapp/pneumaticworkflow](https://github.com/pneumaticapp/pneumaticworkflow) (root: nginx/railway) | Web service |
...
| `ENABLE_LOGGING` | Backend | no | Enable application logging |
...
| `ENABLE_LOGGING` | celery-worker | no | Enable application logging |
...
| `ENABLE_LOGGING` | celery-beat | no | Enable application logging |
...
**Category:** Automation · **Languages:** Python, TypeScript, CSS, HTML, SCSS, Shell, JavaScript, EJS, Dockerfile, Mako

[View on Railway →](https://railway.com/deploy/pneumatic-1)
