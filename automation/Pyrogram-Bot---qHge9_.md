# Deploy Pyrogram Bot on Railway
...
| Service | Source | Type |
|---------|--------|------|
| PyroGramBot | [NotYourBaka/GhostForwarder](https://github.com/NotYourBaka/GhostForwarder) | Worker |

## Environment variables

| Variable | Default | Description |
| --------- | ------- | ----------- |
| `SESSION_STRING` | xx_Your_Session_String_xx | Read README.md for obtaining the Session String |
