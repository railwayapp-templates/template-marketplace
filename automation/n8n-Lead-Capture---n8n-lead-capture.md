# Deploy n8n Lead Capture on Railway

Form to CRM, Sheet and Slack with n8n

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/n8n-lead-capture)
...
[View on Railway →](https://railway.com/deploy/n8n-lead-capture)
