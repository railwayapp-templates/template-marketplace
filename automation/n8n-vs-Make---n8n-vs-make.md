# Deploy n8n vs Make on Railway

self-hosted Make.com alternative

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/n8n-vs-make)
...
[View on Railway →](https://railway.com/deploy/n8n-vs-make)
