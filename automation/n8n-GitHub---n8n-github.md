# Deploy n8n GitHub on Railway

PRs, issues and deploy alerts with n8n

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/n8n-github)
...
[View on Railway →](https://railway.com/deploy/n8n-github)
