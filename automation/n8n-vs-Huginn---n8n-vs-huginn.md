# Deploy n8n vs Huginn on Railway

Huginn / IFTTT self-host alternative

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/n8n-vs-huginn)
...
[View on Railway →](https://railway.com/deploy/n8n-vs-huginn)
