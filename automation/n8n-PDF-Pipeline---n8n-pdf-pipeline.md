# Deploy n8n PDF Pipeline on Railway

Parse PDFs, OCR & extract data

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/n8n-pdf-pipeline)
...
[View on Railway →](https://railway.com/deploy/n8n-pdf-pipeline)
