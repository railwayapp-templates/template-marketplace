# Deploy Postgres Backup to your Google Drive on Railway
...
| Service | Source | Type |
|---------|--------|------|
| backup-postgres-gdrive | [doiska/postgres-gdrive-backup](https://github.com/doiska/postgres-gdrive-backup) | Worker |

## Environment variables

| Variable | Default | Description |
| --------- | ------- | ----------- |
| `FOLDER_ID` | - | The folder id from your GDrive, it will be at the end of the url. |
| `DATABASE_URL` | - | Your database url (includes postgresql://)) |
| `RUN_ON_START` | true | Run the backup right after the service is deployed |
| `CRON_EXPRESSION` | 0 0 * * * | -1 to disable cron (in case you are using Railway's cron) |
| `SERVICE_ACCOUNT` | - | Your Service Account json (https://console.cloud.google.com/projectselector2/iam-admin/serviceaccounts) |
