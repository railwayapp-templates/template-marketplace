# Deploy Bun.js Cron Scheduler on Railway
...
| Service | Source | Type |
|---------|--------|------|
| cron-env | [tsykin/cron-env](https://github.com/tsykin/cron-env) | Worker |

## Environment variables

| Variable | Default | Description |
| --------- | ------- | ----------- |
| `TIMEZONE` | UTC | Timezone in IANA format |
| `RUN_ON_START` | false | Run jobs on startup: "true" || "false" |
| `REQUEST_TIMEOUT` | 60000 | Request timeout in milliseconds (default: 60000 or 1 minute) |
