# Deploy Telegram Bot with Long Polling on Railway
...
| Service | Source | Type |
|---------|--------|------|
| Telegram Bot with Long Polling | [dangos-dev/TelegramBot.LongPolling](https://github.com/dangos-dev/TelegramBot.LongPolling) | Worker |

## Environment variables

| Variable | Default | Description |
| --------- | ------- | ----------- |
| `TELEGRAM_BOT_TOKEN` | (secret) | Secret key for authenticating with the Telegram Bot API |
