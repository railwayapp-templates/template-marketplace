...
| Service | Source | Type |
|---------|--------|------|
| Bot-ApiSWS | [pereyrahugor/Bot-ApiSWS](https://github.com/pereyrahugor/Bot-ApiSWS) | Web service |
...
| `SWS_BASE_URL` | http://demo.chatbot.sistemaws.com | URL endpoint base de servidor SWS |
| `SWS_PASSWORD` | (secret) | Clave Bot SWS |
| `SWS_USERNAME` | (secret) | Usuario Bot SWS |
