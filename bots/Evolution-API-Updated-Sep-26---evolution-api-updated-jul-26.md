# Deploy Evolution API [Updated Sep '26] on Railway

Evolution API [Sep '26] (WhatsApp REST API, No Meta Approval) Self Host
...
**Category:** Bots · **Languages:** JavaScript, Dockerfile, Shell
