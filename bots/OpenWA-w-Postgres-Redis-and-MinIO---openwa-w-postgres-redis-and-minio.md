# Deploy OpenWA (w/ Postgres, Redis and MinIO) on Railway

Deploy OpenWA on Railway. WhatsApp REST API. One click.

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/openwa-w-postgres-redis-and-minio)

## About

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/mFYefU?utm_medium=integration&utm_source=template&utm_campaign=generic)
...
[View on Railway →](https://railway.com/deploy/openwa-w-postgres-redis-and-minio)
