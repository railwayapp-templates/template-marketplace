# Deploy RSS3 Node 1.0 on Railway

A lightweight service that joins the RSS3 Network as a node.

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/template/tAkUiN)
...
| RSS3-Node-Broadcaster | `ghcr.io/rss3-network/node:v1.2.0` | Worker |
| RSS3-Node-Monitor | `ghcr.io/rss3-network/node:v1.2.0` | Worker |
| RSS3-Node-Core | `ghcr.io/rss3-network/node:v1.2.0` | Web service |
| RSS3-Node-VSL-Core | `ghcr.io/rss3-network/node:v1.2.0` | Worker |
...
| `NODE_REDIS_PASSWORD` | RSS3-Node-VSL-Core | (secret) | - |
...
[View on Railway →](https://railway.com/template/tAkUiN)
