# Deploy Zoom VideoSDK Auth Sample on Railway
...
| Service | Source | Type |
|---------|--------|------|
| videosdk-auth-endpoint-sample | [zoom/videosdk-auth-endpoint-sample](https://github.com/zoom/videosdk-auth-endpoint-sample) | Web service |
