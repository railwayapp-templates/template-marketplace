...
| Service | Source | Type |
|---------|--------|------|
| Temporal Matching | [6ixfalls/railway-temporal](https://github.com/6ixfalls/railway-temporal) | Worker |
| Temporal Worker | [6ixfalls/railway-temporal](https://github.com/6ixfalls/railway-temporal) | Worker |
...
| Temporal History | [6ixfalls/railway-temporal](https://github.com/6ixfalls/railway-temporal) | Worker |
| Postgres | `ghcr.io/railwayapp-templates/postgres-ssl:18` | Database |
| Temporal UI | `temporalio/ui:2.49.1` | Worker |
| Temporal Frontend | [6ixfalls/railway-temporal](https://github.com/6ixfalls/railway-temporal) | Worker |

## Environment variables

| Variable | Service | Default | Description |
| --------- | ------- | ------- | ----------- |
| `DB` | Temporal Matching | postgres12_pgx | Database Type - You likely don't need to change this! |
...
| `ES_PORT` | Temporal Matching | - | Elasticsearch Port |
...
| `ES_SCHEME` | Temporal Matching | http | Elasticsearch Scheme |
| `BIND_ON_IP` | Temporal Matching | ::0 | IP to bind on - You likely don't need to change this! |
...
| `TEMPORAL_ADDRESS` | Temporal Matching | - | Private Temporal Address. - You likely don't need to change this! |
| `TEMPORAL_SERVICES` | Temporal Matching | matching | Temporal Service to run. |
| `ES_VISIBILITY_INDEX` | Temporal Matching | temporal_visibility_v1_dev | Elasticsearch Visibility Index - You likely don't need to change this! |
| `TEMPORAL_CLI_ADDRESS` | Temporal Matching | - | Temporal Frontend Address - You likely don't need to change this! |
| `DB` | Temporal Worker | postgres12_pgx | Database Type - You likely don't need to change this! |
...
| `ES_PORT` | Temporal Worker | - | Elasticsearch Port |
...
| `ES_SCHEME` | Temporal Worker | http | Elasticsearch Scheme |
| `BIND_ON_IP` | Temporal Worker | ::0 | IP to bind on - You likely don't need to change this! |
...
| `TEMPORAL_ADDRESS` | Temporal Worker | - | Private Temporal Address. - You likely don't need to change this! |
| `TEMPORAL_SERVICES` | Temporal Worker | worker | Temporal Service to run. |
| `ES_VISIBILITY_INDEX` | Temporal Worker | temporal_visibility_v1_dev | Elasticsearch Visibility Index - You likely don't need to change this! |
...
| `DB` | Temporal History | postgres12_pgx | Database Type - You likely don't need to change this! |
...
| `ES_PORT` | Temporal History | - | Elasticsearch Port |
...
| `ES_SCHEME` | Temporal History | http | Elasticsearch Scheme |
| `BIND_ON_IP` | Temporal History | ::0 | IP to bind on - You likely don't need to change this! |
...
| `TEMPORAL_ADDRESS` | Temporal History | - | Private Temporal Address. - You likely don't need to change this! |
| `TEMPORAL_SERVICES` | Temporal History | history | Temporal Service to run. |
| `ES_VISIBILITY_INDEX` | Temporal History | temporal_visibility_v1_dev | Elasticsearch Visibility Index - You likely don't need to change this! |
...
| `DB` | Temporal Frontend | postgres12_pgx | Database Type - You likely don't need to change this! |
...
| `ES_PORT` | Temporal Frontend | - | Elasticsearch Port |
...
| `ES_SCHEME` | Temporal Frontend | http | Elasticsearch Scheme |
| `BIND_ON_IP` | Temporal Frontend | ::0 | IP to bind on - You likely don't need to change this! |
...
| `TEMPORAL_ADDRESS` | Temporal Frontend | - | Private Temporal Address. - You likely don't need to change this! |
| `TEMPORAL_SERVICES` | Temporal Frontend | frontend | Temporal Service to run. |
| `ES_VISIBILITY_INDEX` | Temporal Frontend | temporal_visibility_v1_dev | Elasticsearch Visibility Index - You likely don't need to change this! |
