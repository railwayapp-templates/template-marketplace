# Deploy TanStack + React Starter on Railway
...
| Service | Source | Type |
|---------|--------|------|
| tanstack-react-vite-template | [gillkyle/tanstack-react-vite-template](https://github.com/gillkyle/tanstack-react-vite-template) | Web service |
