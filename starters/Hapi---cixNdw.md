...
- [hapi](https://hapi.dev/)
- [Introduction to Hapi.js](https://medium.com/the-resonant-web/an-introduction-to-hapi-js-part-1-5f2edcb5eced)

## What gets deployed

| Service | Source | Type |
|---------|--------|------|
| hapi | [railwayapp-templates/hapi](https://github.com/railwayapp-templates/hapi) | Web service |
