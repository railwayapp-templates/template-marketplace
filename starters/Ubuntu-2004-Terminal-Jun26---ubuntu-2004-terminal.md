# Deploy Ubuntu 20.04 Terminal [Jun'26] on Railway

Browser-based Ubuntu 20.04 terminal with persistent storage.

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/ubuntu-2004-terminal)
...
| Service | Source | Type |
|---------|--------|------|
| ubuntu20-railway | [Amritasha/ubuntu20-railway](https://github.com/Amritasha/ubuntu20-railway) | Web service |
...
[View on Railway →](https://railway.com/deploy/ubuntu-2004-terminal)
