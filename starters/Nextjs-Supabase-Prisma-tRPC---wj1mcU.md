# Deploy Next.js + Supabase (Prisma + tRPC) on Railway
...
| Service | Source | Type |
|---------|--------|------|
| nextjs-app | [bambrose24/nextjs-supabase-template](https://github.com/bambrose24/nextjs-supabase-template) | Web service |

## Environment variables

| Variable | Description |
| --------- | ----------- |
| `DIRECT_URL` | Same as DATABASE_URL but should be the direct link (likely with port 5432). See https://supabase.com/docs/guides/database/connecting-to-postgres |
| `DATABASE_URL` | Get from the Supabase dashboard. It probably has port 6543, whereas the DIRECT_URL has port 5432. |
| `NEXT_PUBLIC_SUPABASE_URL` | From Supabase dash |
| `NEXT_PUBLIC_SUPABASE_ANON_KEY` | From Supabase dash |
