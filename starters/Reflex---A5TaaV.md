...
<p align="center">
    <a href="https://reflex.dev/">
        <img style="border-radius: 5px" src="https://raw.githubusercontent.com/reflex-dev/reflex/main/docs/images/reflex_light.svg#gh-dark-mode-only" alt="Logo" width="500">
    </a>
</p>
...
| Service | Source | Type |
|---------|--------|------|
| Reflex | [brody192/reflex-template](https://github.com/brody192/reflex-template) | Web service |

## Environment variables

| Variable | Default | Description |
| --------- | ------- | ----------- |
| `ENV` | prod | Run Reflex in Production mode when on Railway  |
