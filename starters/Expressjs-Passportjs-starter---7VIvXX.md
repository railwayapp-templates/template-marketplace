# Deploy Express.js + Passport.js starter on Railway
...
> Although important notes will be presented here, it is recommended to explore and emerge yourself in a `dfs` way, starting [here](https://github.com/edmondwinston/railway-nodejs/blob/main/src/index.js), as there exists plenty comments that will may or may not help you.
...
| Service | Source | Type |
|---------|--------|------|
| service | [railwayapp-templates/expressjs-passport-starter](https://github.com/railwayapp-templates/expressjs-passport-starter) | Worker |
