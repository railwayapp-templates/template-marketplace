# Deploy Litestar with TailwindCSS on Railway
...
|[r/Litestar](https://www.reddit.com/r/litestar)|
|[PyPI](https://pypi.org/project/litestar/)|

## What gets deployed

| Service | Source | Type |
|---------|--------|------|
| Litestar | [JacobCoffee/litestar-template](https://github.com/JacobCoffee/litestar-template) | Worker |

## Environment variables

| Variable | Default | Description |
| --------- | ------- | ----------- |
| `LITESTAR_APP` | app:app | Litestar App Location |
