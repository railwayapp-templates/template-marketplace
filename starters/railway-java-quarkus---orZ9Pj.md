# Deploy railway-java-quarkus on Railway
...
| Service | Source | Type |
|---------|--------|------|
| railway-java-quarkus | [maxandersen/railway-java-quarkus](https://github.com/maxandersen/railway-java-quarkus) | Web service |
