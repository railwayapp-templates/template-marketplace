...
| --------- | ------- | ----------- |
| `LOG_ENABLED` | true | Refer to the official installer. |
| `PDS_CRAWLERS` | https://bsky.network | Refer to the official installer. |
| `PDS_HOSTNAME` | - | Enter the domain you want to use. |
| `PDS_JWT_SECRET` | (secret) | Refer to the official installer. |
| `PDS_DID_PLC_URL` | https://plc.directory | Refer to the official installer. |
| `PDS_ADMIN_PASSWORD` | (secret) | Refer to the official installer. |
| `PDS_DATA_DIRECTORY` | /pds | Refer to the official installer. |
| `PDS_EMAIL_SMTP_URL` | - | (Optional) Example: smtps://resend:<your api key here>@smtp.resend.com:465/ |
| `PDS_INVITE_REQUIRED` | true | Refer to the official installer. |
| `PDS_BLOB_UPLOAD_LIMIT` | 314572800 | Refer to the official installer. |
| `PDS_BSKY_APP_VIEW_DID` | did:web:api.bsky.app | Refer to the official installer. |
| `PDS_BSKY_APP_VIEW_URL` | https://api.bsky.app | Refer to the official installer. |
| `PDS_EMAIL_FROM_ADDRESS` | - | (Optional) Example: admin@your.domain |
| `PDS_REPORT_SERVICE_DID` | did:plc:ar7c4by46qjdydhdevvrndac | Refer to the official installer. |
| `PDS_REPORT_SERVICE_URL` | https://mod.bsky.app | Refer to the official installer. |
| `PDS_RATE_LIMITS_ENABLED` | true | Refer to the official installer. |
| `PDS_BLOBSTORE_DISK_LOCATION` | /pds/blocks | Refer to the official installer. |
