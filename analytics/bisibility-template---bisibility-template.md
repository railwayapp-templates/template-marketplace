# Deploy bisibility-template on Railway

Self-hosted open-source SEO platform with a PostgreSQL database you own.

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/bisibility-template)
...
| web | `corgicorner/bisibility:0.22.1` | Web service |
...
| worker | `corgicorner/bisibility-worker:0.22.1` | Worker |
...
[View on Railway →](https://railway.com/deploy/bisibility-template)
