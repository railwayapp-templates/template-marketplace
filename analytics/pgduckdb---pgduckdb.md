# Deploy pg_duckdb on Railway

DuckDB powered Postgres for analytics

[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/deploy/pgduckdb)
...
| Service | Source | Type |
|---------|--------|------|
| pg_duckdb | `pgduckdb/pgduckdb:18-main` | Database |
...
[View on Railway →](https://railway.com/deploy/pgduckdb)
