# Deploy MySQL Metrics Prometheus Exporter on Railway
...
| Service | Source | Type |
|---------|--------|------|
| mysql-metrics-collector | [zuchka/railway-mysql-exporter](https://github.com/zuchka/railway-mysql-exporter) | Web service |
